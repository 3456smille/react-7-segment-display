...
const Segment = ({ active, color, size, id, skew }) => {
    ...
    return (React.createElement("div", { className: "outer-style", style: outerStyle },
        React.createElement("div", { className: active ? "inner-style" : "inner-style inactive", style: innerStyle })));
};
